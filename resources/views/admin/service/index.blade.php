        ...
        <div class="col-lg-12">
            <div class="card card-default">
                ...
                <h2 class="card-header  card-header-border-bottom">
                    All About &nbsp; <span style="color: red;">|</span> &nbsp; <a class="float-right" href="{{ route('create.service') }}">Add Service</a>
                </h2>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown show d-inline-block widget-dropdown">
                                            ...
                                            <li class="dropdown-item">
                                                <a href="{{ route('edit.service', $item->id) }}">Edit</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="{{ route('destroy.service', $item->id) }}">Delete</a>
                                            </li>
                                            </ul>
                                        </div>
