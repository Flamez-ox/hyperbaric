...
<html lang="en" dir="ltr">
  ...
  <title>Hyperbaric - Admin Dashboard </title>
  ...
  <!-- FAVICON -->
  <link href="{{ asset('backend/assets/img/image1.png') }} " rel="shortcut icon" />
        ...
        <div class="wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="copyright pl-0">
                    <p class="text-center">&copy; 2018 Copyright Hyperbaric Dashboard  by
                    <a class="text-primary" href="http://www.hyperbaricpipeline.com" target="_blank">Hyperbaric groups</a>.
                    </p>
                </div>
                    <script>
                        var d = new Date();
