        ...
        <div class="col-lg-12">
            <div class="card card-default">
                ...
                <h2 class="card-header  card-header-border-bottom">
                    All Contact &nbsp; <span style="color: red;">|</span> &nbsp; <a class="float-right" href="{{ route('create.contact') }}">Add Contact</a>
                </h2>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown show d-inline-block widget-dropdown">
                                            ...
                                            <li class="dropdown-item">
                                                <a href="{{ route('edit.contact', $item->id) }}">Edit</a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="{{ route('destroy.contact', $item->id) }}">Delete</a>
                                            </li>
                                            </ul>
                                        </div>
